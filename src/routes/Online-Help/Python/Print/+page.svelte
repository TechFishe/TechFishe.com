...
<main class="flex w-screen place-content-center 2xl:max-w-[88.5rem] xl:max-w-[72.5rem] lg:max-w-[56.5rem] md:max-w-[40.5rem] sm:max-w-[32.5rem] px-4 justify-self-center snap-y snap-mandatory">
    ...
    <BaseSection title="Intro" yPos="2xl:top-32 md:top-[17.48rem]">
    ...
    <BaseSection title="Typecasting" yPos="2xl:top-[37rem] md:top-[80.85rem]">
    ...
    <BaseSection title="F-strings" yPos="2xl:top-[67rem] md:top-[146.4rem]">
    ...
    <BaseSection title="The Final 2 Arguments" yPos="2xl:top-[78.5rem] md:top-[171.54rem]">
        ...
        <div class="codeBox">
            ...
            <p class="italic text-rose-500">sep</p>
            <p class="text-sky-400">=</p>
            <p class="text-emerald-400">","</p>
            <p class="text-gray-300">,&nbsp;</p>
            <p class="italic text-rose-500">end</p>
            <p class="text-sky-400">=</p>
            <p class="text-emerald-400">"!"</p>
            <p class="text-pink-500">)</p>
        </div>
    ...
    <BaseSection title="Special Characters" yPos="2xl:top-[87.5rem] md:top-[191.2rem]">
    ...
    <BaseSection title="Closing Words" yPos="2xl:top-[108.75rem] md:top-[237.64rem]">
