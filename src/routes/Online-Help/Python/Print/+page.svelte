...
<main class="flex w-screen place-content-center max-w-[104rem] min-w-[92rem] absolute right-0 snap-y snap-mandatory">
    ...
    <BaseSection title="Typecasting" yPos="top-[37rem]">
    ...
    <BaseSection title="F-strings" yPos="top-[67rem]">
    ...
    <BaseSection title="The Final 2 Arguments" yPos="top-[78.5rem]">
    ...
    <BaseSection title="Special Characters" yPos="top-[87.5rem]">
    ...
    <BaseSection title="Closing Words" yPos="top-[108.75rem]">
