...
<main class="flex w-screen place-content-center 2xl:max-w-[88.5rem] xl:max-w-[72.5rem] lg:max-w-[56.5rem] md:max-w-[40.5rem] sm:max-w-[32.5rem] px-3 justify-self-center snap-y snap-mandatory">
    ...
    <BaseSection title="Intro" yPos="2xl:top-32">
