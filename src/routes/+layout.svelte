...
<div class="flex w-screen h-screen">
    <nav class:shadow-lg="{isMainOpen === true}" class:shadow-md="{isMainOpen === false}" class="backdrop-blur-[2px] z-50 w-screen h-13 -top-1 p-2 items-center justify-between absolute flex rounded bg-gray-600/75 dark:bg-gray-100/75 transition-shadow ease-in-out">
    ...
    <div class:-translate-x-64="{isMainOpen === false}" class="z-10 absolute flex place-content-center w-60 h-screen bg-gray-700 dark:bg-gray-200 rounded transition-transform duration-500 ease-in-out">
