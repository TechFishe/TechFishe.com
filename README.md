...
# Packages
Currently I am using [Angular Material](https://material.angular.io) to do the heavy lifting of the UI. I'm using a custom Gray-Cyan theme but they also have 4 built-in ones you can use. It´s super easy to work with and if you are wanting to quickly make a webiste using Angular or if you are bad with UIs, I suggest checking them out. **#NotSponored**
